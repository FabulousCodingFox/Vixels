            ...
            for (int x = 0; x < Chunk.CHUNK_SIZE; x++) {
                for (int z = 0; z < Chunk.CHUNK_SIZE; z++) {
                    for (int y = 0; y < Chunk.CHUNK_HEIGHT; y++) {
                        ...
                        if (!getBlock(x, y, z, chunk, c4, c1, c3, c6).getTransparent()) {
                            int xp = x + chunk.getX() * Chunk.CHUNK_SIZE;
                            int zp = z + chunk.getY() * Chunk.CHUNK_SIZE;

                            float colorR = BlockState.getBlockColor(block.getBlockType())[0];
                            float colorG = BlockState.getBlockColor(block.getBlockType())[1];
                            float colorB = BlockState.getBlockColor(block.getBlockType())[2];

                            BlockState up = getBlock(x, y + 1, z, chunk, c4, c1, c3, c6);
                            if (up.getTransparent()) {
                                data.addAll(List.of(
                                        -0.5f + xp, 0.5f + y, -0.5f + zp, colorR, colorG, colorB,
                                        0.5f + xp, 0.5f + y, -0.5f + zp, colorR, colorG, colorB,
                                        0.5f + xp, 0.5f + y, 0.5f + zp, colorR, colorG, colorB,
                                        0.5f + xp, 0.5f + y, 0.5f + zp, colorR, colorG, colorB,
                                        -0.5f + xp, 0.5f + y, 0.5f + zp, colorR, colorG, colorB,
                            ...
                            BlockState down = getBlock(x, y - 1, z, chunk, c4, c1, c3, c6);
                            if (down.getTransparent()) {
                                data.addAll(List.of(
                                        -0.5f + xp, -0.5f + y, -0.5f + zp, colorR, colorG, colorB,
                                        0.5f + xp, -0.5f + y, -0.5f + zp, colorR, colorG, colorB,
                                        0.5f + xp, -0.5f + y, 0.5f + zp, colorR, colorG, colorB,
                            ...
                            BlockState left = getBlock(x - 1, y, z, chunk, c4, c1, c3, c6);
                            if (left.getTransparent()) {
                                data.addAll(List.of(
                                        -0.5f + xp, 0.5f + y, 0.5f + zp, colorR, colorG, colorB,
                                        -0.5f + xp, -0.5f + y, -0.5f + zp, colorR, colorG, colorB,
                                        -0.5f + xp, 0.5f + y, -0.5f + zp, colorR, colorG, colorB,
                            ...
                            BlockState right = getBlock(x + 1, y, z, chunk, c4, c1, c3, c6);
                            if (right.getTransparent()) {
                                data.addAll(List.of(
                                        0.5f + xp, 0.5f + y, 0.5f + zp, colorR, colorG, colorB,
                                        0.5f + xp, 0.5f + y, -0.5f + zp, colorR, colorG, colorB,
                                        0.5f + xp, -0.5f + y, -0.5f + zp, colorR, colorG, colorB,
                            ...
                            BlockState front = getBlock(x, y, z + 1, chunk, c4, c1, c3, c6);
                            if (front.getTransparent()) {
                                data.addAll(List.of(
                                        -0.5f + xp, -0.5f + y, 0.5f + zp, colorR, colorG, colorB,
                                        0.5f + xp, 0.5f + y, 0.5f + zp, colorR, colorG, colorB,
                                        0.5f + xp, -0.5f + y, 0.5f + zp, colorR, colorG, colorB,
                            ...
                            BlockState back = getBlock(x, y, z - 1, chunk, c4, c1, c3, c6);
                            if (back.getTransparent()) {
                                data.addAll(List.of(
                                        -0.5f + xp, -0.5f + y, -0.5f + zp, colorR, colorG, colorB,
                                        0.5f + xp, -0.5f + y, -0.5f + zp, colorR, colorG, colorB,
                                        0.5f + xp, 0.5f + y, -0.5f + zp, colorR, colorG, colorB,
